...
### 通过build_transformer_model( keras_weights_path='xx.weights.h5'）方法读取权重，只能使用keras3加载
  ...
  | -------------- | -------------------------- | ------------------------------------------------------------ |-- |---- |--------  |
| [T5.1.1](https://github.com/pass-lin/bert4keras3/blob/main/examples/chatyuan-test-example.py)  | ChatYuan|  [百度网盘](https://pan.baidu.com/s/1huwRA2sOIYL8e7OFg0QTcg?pwd=6u59) 提取码：6u59  |  √|FP32|bert4keras3.tokenizers.SpTokenizer|
