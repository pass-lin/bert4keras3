...
|| Gemma-7b-it-Code| [百度网盘]() 提取码：|  √|BF16|SpTokenizer|
  ...
  | 模型分类| 模型名称和权重链接|支持kv-cache 生成|数据类型|分词器|
  | -------------- | -------------------------------------------------------------------------------------- |-- |---- |--------  |
  | [T5.1.1](https://github.com/pass-lin/bert4keras3/blob/main/examples/chatyuan-test-example.py)  |[ChatYuan](https://pan.baidu.com/s/1huwRA2sOIYL8e7OFg0QTcg?pwd=6u59)
  |  √|FP32|SpTokenizer|
<strong>注意事项</strong>
