...
from bert4keras3.snippets import is_string, is_py2
from bert4keras3.snippets import open
from bert4keras3.snippets import convert_to_unicode
from bert4keras3.snippets import truncate_sequences
from bert4keras3.snippets import lowercase_and_normalize
...
#rwkv tokenizer copy from https://github.com/yuunnn-w/RWKV_Pytorch/blob/main/src/rwkv_tokenizer.py
class TRIE:
...
class RWKV_TOKENIZER():
    ...
    def decode(self, tokens):
        ...
        elif isinstance(tokens[0],int) or isinstance(tokens[0],float):
            return self.decodeBytes(tokens).decode('utf-8')
